...
public class DatabaseCredentials implements ConfigurationSerializable {
    ...
    public DatabaseCredentials(String database, String user, String password, String host,
    ...
    public final @NotNull Map<String, Object> serialize() {
        ...
        objectMap.put("username", this.user);
    ...
    public static @NotNull DatabaseCredentials deserialize(@NotNull Map<String, Object> args) {
        ...
        return new DatabaseCredentials(database, user, password, host, port, poolSize, connectionTimeout, idleTimeout, maxLifetime);
    }
}
